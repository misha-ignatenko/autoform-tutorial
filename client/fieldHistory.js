Template.fieldHistory.helpers({
    ...
    //
    //
    //    //var arrayOfFieldNames = AutoForm.getFieldValue("fieldsToViewUpdateHistoryFor", "fieldToMonitor");
    //    //console.log("array of field names is: ", arrayOfFieldNames);
    //
    //    Session.set("tagSession", ["title", "content", "category"]);
    //    return Session.get("tagSession")[0];
    //}
